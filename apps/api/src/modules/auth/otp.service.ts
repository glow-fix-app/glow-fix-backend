...
export class OtpService {
  ...
  async sendOtpToEmail(userId: string, email: string, purpose: OtpPurpose): Promise<void> {
  ...
  async sendOtpToPhone(userId: string, phone: string, purpose: OtpPurpose): Promise<void> {
  ...
  async verifyOtp(userId: string, otp: string, purpose: OtpPurpose): Promise<boolean> {
  ...
  private async storeOtp(userId: string, purpose: OtpPurpose, otp: string): Promise<void> {
