...
const utils_1 = require("@glow-fix/utils");
const prisma = new client_1.PrismaClient();
async function main() {
    console.log('🌱 Starting database seed...');
    const adminPasswordHash = await bcrypt.hash('Admin@123!', utils_1.PASSWORD.BCRYPT_COST_FACTOR);
    ...
    const staffPasswordHash = await bcrypt.hash('Staff@123!', utils_1.PASSWORD.BCRYPT_COST_FACTOR);
