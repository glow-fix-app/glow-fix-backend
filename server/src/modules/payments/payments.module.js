...
var stripe_provider_1 = require("./providers/stripe.provider");
var PaymentsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [],
            controllers: [payments_controller_1.PaymentsController],
            providers: [payments_service_1.PaymentsService, stripe_provider_1.StripeProvider],
            exports: [payments_service_1.PaymentsService, stripe_provider_1.StripeProvider],
        })];
