...
var ChatUserEntity = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({ description: 'User ID' })];
            _fullName_decorators = [(0, swagger_1.ApiProperty)({ description: 'Full name' })];
            _email_decorators = [(0, swagger_1.ApiProperty)({ description: 'Email address' })];
            _role_decorators = [(0, swagger_1.ApiProperty)({ description: 'Role of the user' })];
