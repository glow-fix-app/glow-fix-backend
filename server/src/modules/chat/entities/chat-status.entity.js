...
exports.ChatStatusEntity = void 0;
var swagger_1 = require("@nestjs/swagger");
var ChatStatusEntity = function () {
    var _a;
    var _id_decorators;
    ...
    return _a = /** @class */ (function () {
            function ChatStatusEntity() {
                this.id = __runInitializers(this, _id_initializers, void 0);
                this.context = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _context_initializers, void 0));
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({ description: 'Status ID' })];
            _context_decorators = [(0, swagger_1.ApiProperty)({ description: 'Status context name (e.g. OPEN, CLOSED, SENT, DELIVERED, READ)' })];
...
exports.ChatStatusEntity = ChatStatusEntity;
