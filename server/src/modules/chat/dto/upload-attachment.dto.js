...
var UploadAttachmentDto = function () {
    var _a;
    var _caption_decorators;
    var _caption_initializers = [];
    var _caption_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UploadAttachmentDto() {
                this.caption = __runInitializers(this, _caption_initializers, void 0);
        ...
        (function () {
            ...
            _caption_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Optional caption for the attachment', maxLength: 500 }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(500)];
