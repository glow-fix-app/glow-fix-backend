...
var RegisterClientDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _fullName_decorators = [(0, swagger_1.ApiProperty)({ example: 'Omar Nasser' }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(2), (0, class_validator_1.MaxLength)(100)];
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'omar@example.com' }), (0, class_validator_1.IsEmail)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === null || value === void 0 ? void 0 : value.toLowerCase().trim();
                })];
            _phone_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: '+201112223344' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.Matches)(/^\+?\d{7,15}$/, { message: 'Invalid phone number format' })];
