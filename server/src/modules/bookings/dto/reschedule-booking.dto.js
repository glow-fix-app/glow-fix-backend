...
var RescheduleBookingDto = function () {
    var _a;
    var _scheduledAt_decorators;
    var _scheduledAt_initializers = [];
    var _scheduledAt_extraInitializers = [];
    return _a = /** @class */ (function () {
            function RescheduleBookingDto() {
                this.scheduledAt = __runInitializers(this, _scheduledAt_initializers, void 0);
                __runInitializers(this, _scheduledAt_extraInitializers);
            }
            return RescheduleBookingDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _scheduledAt_decorators = [(0, swagger_1.ApiProperty)({ description: 'New scheduled date & time', example: '2026-06-16T11:00:00Z' }), (0, class_validator_1.IsDateString)(), (0, class_validator_1.IsNotEmpty)()];
