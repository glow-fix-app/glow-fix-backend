...
import { IsUUID, IsString, IsArray, IsOptional, IsInt, Min, ValidateNested, IsEnum, IsBoolean } from 'class-validator';
...
export class CreateDiagnosticReportDto {
  ...
  @ApiPropertyOptional({ description: 'Valid for hours', default: 72 })
  @IsOptional()
  @IsInt()
  @Min(1)
  valid_hours?: number;
