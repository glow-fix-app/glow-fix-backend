...
var avatar_controller_1 = require("./avatar.controller");
var avatar_service_1 = require("./avatar.service");
var storage_module_1 = require("../../core/storage/storage.module");
// PrismaService and WinstonLoggerService are assumed global.
// If not, import their modules here explicitly.
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            controllers: [users_controller_1.UsersController, avatar_controller_1.AvatarController],
            providers: [users_service_1.UsersService, avatar_service_1.AvatarService],
            //exports: [UsersService, AvatarService],
            imports: [storage_module_1.StorageModule], // no imports needed if PrismaService and WinstonLoggerService are global
        })];
