...
var CorrelationIdMiddleware = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var CorrelationIdMiddleware = _classThis = /** @class */ (function () {
        function CorrelationIdMiddleware_1() {
        }
        CorrelationIdMiddleware_1.prototype.use = function (req, res, next) {
            var correlationId = req.headers['x-correlation-id'] || (0, uuid_1.v4)();
            req.correlationId = correlationId;
            res.setHeader('X-Correlation-Id', correlationId);
            next();
        };
        return CorrelationIdMiddleware_1;
    }());
