...
var HealthController = function () {
    var _classDecorators = [(0, common_1.Controller)('health'), (0, swagger_1.ApiTags)('Health')];
    ...
    var HealthController = _classThis = /** @class */ (function () {
        ...
        HealthController_1.prototype.readiness = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.healthService.checkReadiness()];
                        case 1:
                            checks = _a.sent();
                            allHealthy = Object.values(checks).every(function (status) { return status === 'ok'; });
                            return [2 /*return*/, {
        ...
        HealthController_1.prototype.detailed = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.healthService.getDetailedHealth()];
                });
            });
        };
    ...
    (function () {
        ...
        _liveness_decorators = [(0, common_1.Get)('live'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Liveness probe' })];
        _readiness_decorators = [(0, common_1.Get)('ready'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Readiness probe' })];
        _detailed_decorators = [(0, common_1.Get)('detailed'), (0, swagger_1.ApiOperation)({ summary: 'Detailed health check (admin only)' })];
