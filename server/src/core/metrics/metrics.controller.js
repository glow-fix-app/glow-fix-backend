...
var MetricsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Metrics'), (0, common_1.Controller)('metrics')];
    ...
    var MetricsController = _classThis = /** @class */ (function () {
        ...
        MetricsController_1.prototype.getMetrics = function (response) {
            return __awaiter(this, void 0, void 0, function () {
                var metrics;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.metricsService.getMetrics()];
                        case 1:
                            metrics = _a.sent();
                            response
    ...
    (function () {
        ...
        _getMetrics_decorators = [(0, common_1.Get)(), (0, public_decorator_1.Public)(), (0, swagger_1.ApiExcludeEndpoint)()];
