...
var USER_AGENT = 'GlowFix/1.0 (support@glowfix.app)';
/**
...
function reverseGeocodeCity(lat, lng) {
    return __awaiter(this, void 0, void 0, function () {
        var url, response, data, addr, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    url = "".concat(NOMINATIM_URL, "?lat=").concat(lat, "&lon=").concat(lng, "&format=json&addressdetails=1&zoom=12&accept-language=en");
                ...
                case 2:
                    data = (_b.sent());
                    addr = data === null || data === void 0 ? void 0 : data.address;
                    if (!addr)
                        return [2 /*return*/, null];
                    // Prefer the most specific locality label available
                    return [2 /*return*/, (addr.city_district ||
                            addr.suburb ||
                            addr.neighbourhood ||
                            addr.city ||
                            addr.town ||
